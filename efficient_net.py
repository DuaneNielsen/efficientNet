...
phi_values = {
    ...
    "b0": (0, 224, 0.2),  # alpha, beta, gama, depth, = alpha ** phi
    "b1": (0.5, 240, 0.2),
    "b2": (1.0, 260, 0.3),
    "b3": (2, 300, 0.3),
    "b4": (3, 380, 0.4),
...
class InvertedResidualBlock(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride, padding, expand_ratio, reduction=4, survial_prob=0.8):
        super().__init__()
...
def test():
    device = "cuda:0"
    version = "b0"
    ph, res, drop_rate = phi_values[version]
